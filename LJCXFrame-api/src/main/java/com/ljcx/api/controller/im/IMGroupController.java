...
public class IMGroupController {
    ...
    public ResponseInfo groupCreate(@RequestBody String info) {
        ...
        if(StringUtils.isNotEmpty(teamBean.getImGroupName())){
            return new ResponseInfo(teamBean.getImGroupName());
        }
        ...
        if(imResponse.getActionStatus().equals("OK")){
            return new ResponseInfo(new JSONObject().put("GroupId",imGroupDto.getGroupId()));
        }
