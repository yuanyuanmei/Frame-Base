package com.ljcx.quartz.service.impl;
...
public class SysJobServiceImpl extends ServiceImpl<SysJobMapper,SysJob> implements ISysJobService
{
     ...
     */
    @Override
    public IPage<SysJob> selectJobList(SysJobDto job)
    {
        IPage<SysJob> page = new Page<>();
        page.setCurrent(job.getPageNum());
        page.setSize(job.getPageSize());
